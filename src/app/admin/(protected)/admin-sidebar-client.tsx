...
const navGroups = [
  ...
  { label:"Takas", items:[{label:"Takas cihazları",href:"/admin/trade-in"},{label:"Fiyat motoru",href:"/admin/pricing"}] },
  { label:"Teknik Servis", items:[{label:"Servis kayıtları",href:"/admin/technical-service#servis-kayitlari"},{label:"Yeni servis kaydı",href:"/admin/technical-service#yeni-kayit"},{label:"Fiyat motoru",href:"/admin/pricing"},{label:"Servis barkodu",href:"/admin/technical-service/scanner"},{label:"Arşiv",href:"/admin/technical-service#arsiv"}] },
