...
const navGroups = [
  { label:"Ürün Yönetimi", items:[{label:"Ürünler",href:"/admin/listings"},{label:"Yeni ürün ekle",href:"/admin/listings/new"},{label:"Siparişler",href:"/admin/purchases"},{label:"Barkod tara",href:"/admin/scan"},{label:"Etiket yazdır",href:"/admin/labels"}] },
