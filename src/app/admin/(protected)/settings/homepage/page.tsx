...
export default async function HomepageSettingsPage() {
  ...
  return <main className="adminShell">
    ...
    <section className="adminDashboardCard"><HomepageExperienceForm initial={{
      ...
      sliderTransition:(data?.slider_transition??FALLBACK_SITE_SETTINGS.slider_transition) as "slide"|"fade"|"zoom"|"flip"|"blur"|"stack",
      sliderRevealEffect:(data?.slider_reveal_effect??FALLBACK_SITE_SETTINGS.slider_reveal_effect) as "rise"|"fade"|"zoom"|"left"|"right"|"blur"|"tilt"|"none",
