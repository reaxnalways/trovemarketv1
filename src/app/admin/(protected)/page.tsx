...
export default async function AdminHomePage({ searchParams }: AdminHomePageProps) {
  ...
  return <main className="adminShell adminShellWide">
    ...
    <section className="adminDashboardCard adminHomeBridge"><div><h2 style={{margin:0}}>Site yönetimi</h2><p className="adminLead">Marka, site ve ana sayfa ayarlarını birbirinden bağımsız yönet.</p></div><div className="adminHomeBridgeActions"><Link className="adminButton adminButtonSecondary" href="/admin/settings/company">Şirket ayarları</Link><Link className="adminButton adminButtonSecondary" href="/admin/settings/site">Site ayarları</Link><Link className="adminButton adminButtonSecondary" href="/admin/settings/homepage">Ana sayfa ayarları</Link><Link className="adminButton adminButtonSecondary" href="/admin/content">Slider görselleri</Link><Link className="adminButton" href="/" target="_blank">Siteyi gör</Link></div></section>
