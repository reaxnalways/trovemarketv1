...
export default async function AdminHomePage({ searchParams }: AdminHomePageProps) {
  ...
  const [draftResult, totalResult, publishedResult, soldResult, featuredResult] = await Promise.all([
  ...
  return <main className="adminShell adminShellWide">
    ...
    <section className="adminDashboardCard adminHeroCard"><div><p className="eyebrow">MAĞAZA KONTROL MERKEZİ</p><h1>Günlük işlemler tek ekranda.</h1><p>Yeni ilan, barkod tarama, stok ve yayın işlemlerini hızlıca yönetin.</p></div></section>
